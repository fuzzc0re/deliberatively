...
pub struct ContributeToVoteMarketArgs {
    pub amount: u64,
}
...
pub fn process_contribute_to_vote_market(
    program_id: &Pubkey,
    accounts: &[AccountInfo],
    args: ContributeToVoteMarketArgs,
) -> ProgramResult {
    ...
    assert_account_is_owned_by(accounts.initializer, program_id)?;
